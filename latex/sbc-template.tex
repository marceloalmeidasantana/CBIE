...
%resultados
A educação a distância vem sendo cada vez mais utilizada pelas instituições de ensino, um dos métodos mais utilizados é o que usa a internet como meio de comunicação. Diante desse cenário, uma ferramenta essencial para o sucesso da educação a distância são os ambientes virtuais de aprendizagem (AVA). Esses ambientes fornecem uma série de ferramentas e recursos que auxiliam no processo de ensino e aprendizagem dos estudantes e facilitam na comunicação entre professores, tutores e estudantes. Este estudo tem como principal objetivo verificar a eficácia destas ferramentas e analisar se essas ferramentas interferem no desempenho dos estudantes. Para realização deste trabalho foi utilizado dois métodos. O primeiro foi aplicar técnicas de mineração de dados sobre uma base real do AVA moodle, e o segundo foi aplicar um questionário aos tutores online, posteriormente foi feito um comparativo entre esses dois métodos. Após análise dos experimentos realizados, os resultados apontaram que muitas das ferramentas disponíveis estão sendo subutilizadas e que não estão influenciando no desempenho dos estudantes.
\end{resumo}
